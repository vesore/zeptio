  ...
  return (
    <main className="min-h-screen py-16 px-6" style={{ background: '#EFEFEF' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-4xl font-black tracking-tight mb-2" style={{ color: '#1A1A1A' }}>Privacy Policy</h1>
        ...
        <div className="flex flex-col gap-10 text-base leading-relaxed" style={{ color: '#444444' }}>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>What we collect</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>How we use it</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>Data storage</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>Your rights</h2>
