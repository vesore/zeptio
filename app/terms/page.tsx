...
export default function TermsPage() {
  return (
    <main className="min-h-screen py-16 px-6" style={{ background: '#EFEFEF' }}>
      <div className="max-w-2xl mx-auto">

        <Link href="/" className="text-sm transition-colors duration-200 hover:text-[#4A90E2] mb-10 inline-block" style={{ color: '#888888' }}>
          ← Back
        </Link>

        <p className="font-mono font-bold tracking-widest text-sm uppercase mb-4" style={{ color: '#4A90E2' }}>Zeptio LLC</p>
        <h1 className="text-4xl font-black tracking-tight mb-2" style={{ color: '#1A1A1A' }}>Terms of Service</h1>
        ...
        <div className="flex flex-col gap-10 text-base leading-relaxed" style={{ color: '#444444' }}>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>What is Zeptio</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>Acceptable use</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>No guarantee during beta</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>Intellectual property</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>Limitation of liability</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight mb-3" style={{ color: '#1A1A1A' }}>Contact</h2>
            <p>
        ...
        <div className="mt-6 pt-8 flex gap-6 text-sm" style={{ borderTop: '1px solid #E0E0E0', color: '#999999' }}>
          <Link href="/privacy" className="hover:text-[#4A90E2] transition-colors duration-200">Privacy Policy</Link>
          <Link href="/support" className="hover:text-[#4A90E2] transition-colors duration-200">Support</Link>
        </div>
