  ...
  return (
    <main className="min-h-screen py-16 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <Link href="/" className="text-sm transition-colors duration-200 hover:text-[#00FF88] mb-10 inline-block" style={{ color: '#888888' }}>
          ← Back
        </Link>
        ...
        <div className="flex flex-col gap-10 text-base leading-relaxed" style={{ color: '#444444' }}>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight text-white mb-3">What is Zeptio</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight text-white mb-3">Acceptable use</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight text-white mb-3">No guarantee during beta</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight text-white mb-3">Intellectual property</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight text-white mb-3">Limitation of liability</h2>
          ...
          <section>
            <h2 className="fredoka text-xl font-black tracking-tight text-white mb-3">Contact</h2>
            <p>
