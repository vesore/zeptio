                ...
                {ROLES.map((r) => {
                  ...
                  return (
                    <button
                      ...
                      style={{ background: isSelected ? 'rgba(226,160,74,0.15)' : 'rgba(0,0,0,0.02)', border: `1.5px solid ${isSelected ? '#B87333' : 'rgba(0,0,0,0.08)'}`, color: isSelected ? '#B87333' : '#666666', cursor: 'pointer' }}
