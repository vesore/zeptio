        ...
        <div className="w-full rounded-3xl p-5 sm:p-8 flex flex-col gap-5 sm:gap-6" style={{ background: '#FAFAFA', border: '1.5px solid #E8E8E8',  }}>
          ...
          <div className="rounded-2xl p-5" style={{ background: 'rgba(226,74,74,0.08)', border: '1px solid rgba(226,74,74,0.2)' }}>
            <div className="flex items-center justify-between mb-3">
              <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#E24A4A' }}>Weak Prompt</p>
          ...
          {/* Goal reminder */}
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest mb-2" style={{ color: '#4A90E2' }}>Original Goal</p>
            <p className="text-sm leading-relaxed" style={{ color: '#555555' }}>{levelConfig.challenge}</p>
          </div>

          {result === null && (
            <div className="flex flex-col gap-3">
              <label htmlFor="rewrite-input" className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#4A90E2' }}>
